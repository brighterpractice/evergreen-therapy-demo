...
export const servicePages: Record<string, ServicePageContent> = {
  ...
  'grief-loss': {
    title: 'Grief & Loss Counseling in Meridian, Idaho',
    description: 'Thoughtful individual counseling for grief and significant loss at Bright Hope Therapy in Meridian, Idaho.',
  ...
  'chronic-pain-chronic-illness': {
    title: 'Chronic Pain & Illness Counseling | Meridian, ID',
    description: 'Counseling for adults living with chronic pain or illness, with support for grief, adjustment, identity, stress, and relationships in Meridian, Idaho.',
  ...
  'life-transitions': {
    title: 'Life Transitions Counseling | Meridian, ID',
    description: 'Individual counseling for major changes in roles, identity, work, family, and relationships in Meridian, Idaho.',
  ...
  'self-esteem-personal-growth': {
    title: 'Self-Esteem & Growth | Meridian, ID',
    description: 'Counseling for self-esteem, values, boundaries, confidence, and personal growth in Meridian, Idaho.',
