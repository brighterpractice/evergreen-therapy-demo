...
export const services: Service[] = [
  ...
  { slug: 'emdr-therapy', title: 'EMDR Therapy', href: '/approaches/emdr/', description: 'EMDR is a structured therapeutic approach that may help some clients work with distressing experiences and responses. Its use depends on individual needs and readiness.', published: true },
